...
export default function HUD() {
  return (
    <div className="overflow-hidden w-[120px] h-[120px] flex hover:w-max transition-all duration-800 border-4 border-slate-200 rounded-full ease-in-out outline-4 outline-slate-400">
      {/* Open State */}
          ...
          <button className="cursor-pointer hover:translate-y-[-5px] hover:scale-[102%] focus:translate-y-[-5px] transition-all duration-200 ease-in-out">
            <div className="">
              <div className="group bg-slate-100 border-b-6 border-slate-300 h-[100px] w-[100px] rounded-2xl flex items-center justify-center">
                <span className="text-7xl drop-shadow-lg">🗺️</span>
                <div className="font-bold text-lg transition-all group-hover:opacity-100 opacity-0 group-hover:-bottom-1 -bottom-7 absolute bg-blue-500 border-blue-600 text-white border-b-2 px-4 rounded-full duration-500">
                  Tickets
                </div>
              </div>
            </div>
